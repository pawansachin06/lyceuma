<x-admin-layout sweetalert="1" tippy="1">
    <div class="lg:container px-3 py-3">
        <div class="mb-2 flex flex-wrap justify-between items-center">
            ...
            <form action="{{ route('subjects.store') }}" method="post" data-js="app-create-form">
                <x-button data-js="app-form-btn" type="submit" class="hidden">Create</x-button>
            </form>
        </div>
                            ...
                            <tr class="border border-b border-gray-100">
                                ...
                                <td class="px-2 py-2">
                                    <div class="inline-flex flex items-center flex-wrap gap-1 justify-end">
                                        <x-button href="{{ route('subjects.edit', $item->id) }}" size="sm">Edit</x-button>
                                        <form action="{{ route('subjects.destroy', $item->id) }}" method="post" data-js="app-delete-form">
                                            @method('DELETE')
