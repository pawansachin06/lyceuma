<x-admin-layout>
    <div class="lg:container px-3 py-3">
        <div class="mb-2 flex flex-wrap justify-between items-center">
            <div class="">
                <h1 class="text-2xl font-sans font-semibold">Edit Class</h1>
            </div>
            <div class="">
                <x-button href="{{ route('exam-classes.index') }}">Back</x-button>
            </div>
        </div>
        <form action="{{ route('exam-classes.update', $item) }}" method="post" data-js="app-form">
            @method('PUT')
