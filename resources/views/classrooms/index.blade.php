<x-admin-layout sweetalert="1">
    <div class="lg:container px-3 py-3">
        <div class="mb-2 flex flex-wrap justify-between items-center">
            ...
            <form action="{{ route('classrooms.store') }}" method="post" data-js="app-create-form">
                            ...
                            <tr class="border border-b border-gray-100">
                                ...
                                <td class="px-2 py-2">
                                    <div class="inline-flex flex items-center flex-wrap gap-1 justify-end">
                                        <x-button href="{{ route('classrooms.edit', $item->id) }}" size="sm">Edit</x-button>
                                        <form action="{{ route('classrooms.destroy', $item->id) }}" method="post" data-js="app-delete-form">
                                            @method('DELETE')
