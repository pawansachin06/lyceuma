        ...
        <form action="{{ route('questions.update', ['tableId'=> $tableId, 'quesId' => $item->id]) }}" method="post" data-js="app-form">
            ...
            <div class="flex flex-wrap -mx-1">
                ...
                <div data-js="question-parent-id-box" class="w-full sm:w-6/12 px-1 mb-3">
                    ...
                    <input type="number" name="parent_id" data-js="question-parent-id" value="{{ $item->parent_id }}" min="1" step="1" class="rounded w-full focus:border-primary-500 focus:ring-primary-400" />
                </div>
                <div data-js="question-parent-order-box" class="w-full sm:w-6/12 px-1 mb-3">
                    ...
                    <input type="number" name="parent_order" data-js="question-parent-order" value="{{ $item->parent_order }}" min="1" step="1" class="rounded w-full focus:border-primary-500 focus:ring-primary-400" />
                </div>
                <div class="w-full sm:w-6/12 px-1 mb-3">
